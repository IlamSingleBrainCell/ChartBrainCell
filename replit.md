...
- January 13, 2025: Integrated SEBI RSS feed (https://www.sebi.gov.in/sebirss.xml) for Indian regulatory news and updates. Added xml2js package for RSS parsing, created /api/sebi/news endpoint with proper categorization (enforcement, recovery, appeal, settlement, compliance), and built modern SEBI news component with professional card design displaying regulatory updates on homepage. This provides valuable regulatory intelligence for NSE/BSE stock traders with live updates every 10 minutes
